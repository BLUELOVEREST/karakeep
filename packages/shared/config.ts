...
const allEnv = z.object({
  ...
  XIAOHONGSHU_SPIDER_DOWNLOAD_ENDPOINT: z.string().url().optional(),
  XIAOHONGSHU_MCP_ENDPOINT: z.string().url().optional(),
  COOLAPK_RESOLVER_ENDPOINT: z.string().url().optional(),
  SMZDM_RESOLVER_ENDPOINT: z.string().url().optional(),
  WECHAT_ARTICLE_RESOLVER_ENDPOINT: z.string().url().optional(),
  WECHAT_ARTICLE_AUTH_KEY: z.string().optional(),
  DOUYIN_RESOLVER_ENDPOINT: z.string().url().optional(),
  ...
  const obj = {
    ...
    crawler: {
      ...
      xiaohongshuSpiderDownloadEndpoint:
        val.XIAOHONGSHU_SPIDER_DOWNLOAD_ENDPOINT,
      xiaohongshuMcpEndpoint: val.XIAOHONGSHU_MCP_ENDPOINT,
      coolapkResolverEndpoint: val.COOLAPK_RESOLVER_ENDPOINT,
      smzdmResolverEndpoint: val.SMZDM_RESOLVER_ENDPOINT,
      wechatArticleResolverEndpoint: val.WECHAT_ARTICLE_RESOLVER_ENDPOINT,
      wechatArticleAuthKey: val.WECHAT_ARTICLE_AUTH_KEY,
      douyinResolverEndpoint: val.DOUYIN_RESOLVER_ENDPOINT,
    },
    ocr: {
      langs: val.OCR_LANGS,
